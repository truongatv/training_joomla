...
define( 'URL', 'http://localhost:8888/Joomla_1.5.26-2/' );
define( 'SECUREURL', 'http://localhost:8888/Joomla_1.5.26-2/' );
...
define('VM_REVIEWS_MINIMUM_COMMENT_LENGTH', '10');
...
define('DOWNLOADROOT', '/Applications/MAMP/htdocs/Joomla_1.5.26-2/');
...
define('ENCODE_KEY', 'b79472f3518b8d32e6103025abdb5d36');
define('NO_SHIPPING', '');
define('NO_SHIPTO', '');
