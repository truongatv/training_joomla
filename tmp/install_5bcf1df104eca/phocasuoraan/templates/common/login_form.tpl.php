...
<form action="index.php" method="post" name="login" style="margin-left:20px;">
	<table><tr><td>
	<label for="username_login"><?php echo $VM_LANG->_('USERNAME') ?>:</label></td>
	<td><input type="text" id="username_login" name="username" class="inputbox" size="20" /></td><td></td></tr>
	<tr><td>
	<label for="passwd_login"><?php echo $VM_LANG->_('PASSWORD') ?>:</label></td>
	<td><input type="password" id="passwd_login" name="passwd" class="inputbox" size="20" /></td><td>
	(<a title="<?php echo $VM_LANG->_('LOST_PASSWORD'); ?>" href="<?php echo $lostPwUrl; ?>"><?php echo $VM_LANG->_('LOST_PASSWORD'); ?></a>)
	</td></tr>
	<tr><td colspan="2" align="right">
	<input type="submit" name="Submit" class="button" value="<?php echo $VM_LANG->_('BUTTON_LOGIN') ?>" /></td><td></td></tr></table>
