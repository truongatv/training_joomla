...
<?php if( $my->id > 0)  { ?>
    <tr>
      ...
      <a href="<?php $sess->purl(SECUREURL . "index.php?page=account.billing") ?>">
          <?php 
          echo "<img src=\"".VM_THEMEURL."images/identity.png\" align=\"middle\" height=\"32\" width=\"32\" border=\"0\" alt=\"".$VM_LANG->_('PHPSHOP_ACCOUNT_TITLE')."\" />";?></a>&nbsp;
          
		  <strong><a href="<?php $sess->purl(SECUREURL . "index.php?page=account.billing") ?>"><?php
	...
	?>
		...
		<tr>
		  <td><hr />
		  <a href="<?php $sess->purl(SECUREURL . "index.php?page=account.shipping") ?>"><?php
          echo "<img src=\"".VM_THEMEURL."images/web.png\" align=\"middle\" border=\"0\" height=\"32\" width=\"32\" alt=\"".$VM_LANG->_('PHPSHOP_ACC_SHIP_INFO')."\" />";?></a>&nbsp;
...
<?php } ?>
    <tr>
      <td>
      	<hr />
      	<?php 
	      echo "<img src=\"".VM_THEMEURL."images/package.png\" align=\"middle\" height=\"32\" width=\"32\" border=\"0\" alt=\"".$VM_LANG->_('PHPSHOP_ACC_ORDER_INFO')."\" />";?>&nbsp;<strong><?php 
