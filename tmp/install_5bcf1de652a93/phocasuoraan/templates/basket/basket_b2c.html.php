...
<?php foreach( $product_rows as $product ) { ?>
  <tr valign="top" class="<?php echo $product['row_color'] ?>">
	<td class="sectiontableentry1"><?php echo $product['product_name'] . $product['product_attributes'] ?></td>
	<td class="sectiontableentry1"><?php echo $product['product_sku'] ?></td>
	<td class="sectiontableentry1" align="right"><?php echo $product['product_price'] ?></td>
	<td class="sectiontableentry1"><?php echo $product['update_form'] ?><?php echo $product['delete_form'] ?></td>
    <td class="sectiontableentry1" align="right"><?php echo $product['subtotal'] ?></td>
  </tr>
<?php } ?>
