...
if (!$alreadycommented) {
    ...
    <input class="button" type="submit" onclick="return( check_reviewform());" name="submit_review" title="<?php echo $VM_LANG->_('PHPSHOP_REVIEW_SUBMIT')  ?>" value="<?php echo $VM_LANG->_('PHPSHOP_REVIEW_SUBMIT')  ?>" /></div><br />
